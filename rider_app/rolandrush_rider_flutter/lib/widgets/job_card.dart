        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Container(height: 16, width: 1, color: AppColors.line),
              const SizedBox(width: 10),
              const Icon(Icons.payments_outlined, size: 20, color: AppColors.inkMuted),
              const SizedBox(width: 6),
              Text(naira(order.totalAmount), style: AppTheme.sans(size: 15, weight: FontWeight.w700, color: AppColors.inkMuted)),
            ]),
          ),
          const SizedBox(height: 12),
          RichText(
